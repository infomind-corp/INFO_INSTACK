...
├── auth/            ← JWT 인증 (controller / dao / entity / model / repository / service/impl / mapper/{postgresql,oracle})
├── cms/             ← 관리자 API (/api/cms/**)
│   └── {domain}/    ← controller / dao / entity / model / repository / service/impl / mapper/{postgresql,oracle}
